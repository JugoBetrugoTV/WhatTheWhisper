...
@icon("pin")
def _(p):
    p.circle(32, 25, 12, outline=(255, 255, 255, 255), w=W)
    p.line(23.5, 33.5, 32, 51, W)
    p.line(40.5, 33.5, 32, 51, W)


@icon("pin_filled")
def _(p):
    p.circle(32, 25, 13, fill=(255, 255, 255, 255))
    p.poly([(21, 33), (43, 33), (32, 53)])
    p.circle(32, 25, 4.6, fill=CLEAR)
...
@icon("dock")
def _(p):
    p.polyline([(26, 17), (47, 17), (47, 47), (17, 47), (17, 28)], W)
    p.line(15, 15, 30, 30, W)
    p.polyline([(30, 21), (30, 30), (21, 30)], W - 0.6)


@icon("shield")
def _(p):
    p.polyline([(32, 11), (51, 19), (48, 37), (32, 53), (16, 37), (13, 19), (32, 11)], W - 0.4)
...
def main():
    ...
    atlas.save(preview_path("icons.png"))
