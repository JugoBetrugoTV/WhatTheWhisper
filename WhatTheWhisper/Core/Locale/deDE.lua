...
ns.RegisterLocale("deDE", {
	...
	["A character here has a first and a second name, both letters only."] = "Ein Charakter hat hier einen Vor- und einen Nachnamen, beide nur aus Buchstaben.",
	["There are no public profile sites for this version of the game yet."] = "Für diese Version des Spiels gibt es noch keine öffentlichen Profilseiten.",
	["The profile sites do not cover this region."] = "Die Profilseiten decken diese Region nicht ab.",
	["This realm's name cannot be turned into a web address here."] = "Aus dem Namen dieses Realms lässt sich hier keine Webadresse bilden.",
	["Click an address, then press Ctrl+C to copy it."] = "Adresse anklicken, dann Strg+C zum Kopieren drücken.",
	["Remove friend"] = "Freund entfernen",
	["Unignore"] = "Nicht mehr ignorieren",
	["Show whispers"] = "Flüstern anzeigen",
	["Messenger only"] = "Nur im Messenger",
	["Messenger and chat"] = "Messenger und Chat",
	["For whispers you receive and whispers you send. Nothing is lost either way."] = "Gilt für empfangene und gesendete Flüsternachrichten. Verloren geht so oder so nichts.",
	["New whispers open"] = "Neues Flüstern öffnet",
	["In the messenger"] = "Im Messenger",
	["In their own window"] = "Im eigenen Fenster",
})
